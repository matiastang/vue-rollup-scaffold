 ...
 * @LastEditTime: 2022-05-19 16:07:39
...
import { RangeRound, ChartsGrid, DefectPositionOptionalThemeColors } from '../../@types/index'
...
export default defineComponent({
    ...
    props: {
         ...
         */
        chartTheme: {
            type: Object as PropType<DefectPositionOptionalThemeColors>,
            default: () => {
                return {}
            },
        },
                ...
                series: [
                    {
                        type: 'line',
                        lineStyle: {
                            color: colors.value.color || colors.value.seriesLineStyleColor,
                            width: 2,
                        },
                        emphasis: {
                            lineStyle: {
