 ...
 * @LastEditTime: 2021-12-29 13:48:37
 * @FilePath: /datumwealth-front-scaffold/src/api/request/modules/home/home.ts
 * @Description: 首页相关接口
 */
import http from '@/api/request/request'
import { HotType, SolutionType, BannerType } from './homeInterface'
import { apiPrefix, contentPrefix } from '@/api/request/prefix'
