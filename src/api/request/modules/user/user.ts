 ...
 * @LastEditTime: 2021-12-29 13:50:35
 * @FilePath: /datumwealth-front-scaffold/src/api/request/modules/user/user.ts
 * @Description: 用户相关接口
 */
import http from '@/api/request/request'
import { Md5 } from 'ts-md5/dist/md5'
import { MbMemberAuthLogs, UserLoginInfo } from '@/@types/user'
import { memberPrefix, loginPrefix } from '@/api/request/prefix'
import {
    LoginParameters,
    FotgetParameters,
