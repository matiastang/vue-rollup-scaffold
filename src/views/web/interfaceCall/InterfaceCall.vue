...
<template>
    <div class="interface-call borderBox flexColumnCenter">
                    ...
                    <div class="bottom-right-content borderBox flexRowCenter">
                        <div class="bottom-right-parameters borderBox flexColumnCenter">
                            ...
                            <div class="parameters-item flexRowCenter">
                                ...
                                <div
                                    v-if="getApiInfoData.data.apiName"
                                    class="parameters-item-text defaultFont"
                                >
                                    {{ getApiInfoData.data.apiName }}
                                </div>
                            ...
                            <div class="parameters-item flexRowCenter">
                                ...
                                <div
                                    v-if="getApiInfoData.data.apiCode"
                                    class="parameters-item-text defaultFont"
                                >
                                    {{ getApiInfoData.data.apiCode }}
                                </div>
                                <el-skeleton v-else style="padding-right: 12px">
                                    <template #template>
                                        <el-skeleton-item variant="p" />
        ...
        />
        <InterfaceAffix v-if="isApplyTry !== 1" @click="showApplyTrialModel" />
    </div>
</template>
<script lang="ts">
